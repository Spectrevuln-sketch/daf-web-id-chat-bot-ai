                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="affiliate_payout_methods" name="affiliate_payout_methods" class="form-control"><?= get_option("affiliate_payout_methods", "Paypal, Bank Deposit"); ?></textarea>
