                        ...
                        <div class="message-content">
                            ...
                            <form id="ai-chat-form">
                                <div class="message-reply">
                                    ...
                                    <textarea placeholder="<?php _e('Type your message here (Use shift + Enter to send)') ?>" id="ai-chat-textarea" rows="1"></textarea>
                ...
                <div class="popup-tab-content">
                    ...
                    <div id="chat-prompts-list">
                        <?php foreach ($chat_prompts as $chat_prompt) { ?>
                            <a href="javascript:void(0)" data-search-key="<?php _esc(escape($chat_prompt['prompt'] . ' '. $chat_prompt['description'])) ?>" data-prompt="<?php _esc(escape($chat_prompt['prompt'])) ?>">
