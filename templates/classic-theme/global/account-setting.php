                            ...
                            <div class="content with-padding">
                                <form method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="submit-field">
                                                ...
                                                <div class="input-with-icon-left">
                                                    ...
                                                    <input type="text" readonly class="with-border" id="email" name="email" value="<?php _esc($email_field)?>" onBlur="checkAvailabilityEmail()">
                                                </div>
                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="submit-field">
                                                <h5><?php _e("Whatsapp Number") ?> *</h5>
                                                <div class="input-with-icon-left">
                                                    <i class="country-number"><small>+62</small></i>
                                                    <input type="text" readonly class="with-border" id="phone" name="phone" value="<?php _esc(preg_replace('/^[0]/', '', $phone_field))?>" onBlur="checkAvailabilityPhone()">
                                                </div>
