...
<div class="container" style="margin-bottom:10em;">
    <div class="row">
        <div class="col-xl-5 offset-xl-3">
            <div class="login-register-page">
                ...
                <input type="hidden" name="delete" value="ajax_delete_otp"/>
    ...
    <script>
        ...
        var compareTimeM = Math.floor(parseInt(timeMNow) - parseInt(timeMCurrent))
        var compareTimeS = Math.floor(parseInt(timeSCurrent) - parseInt(timeSNow))
        var timer2 = `${compareTimeM}:00`
        console.log(timer2)
        console.log(end);
        var endLimitTime = '';
 var interval = setInterval(function() {
        ...
        const end = isNaN(minutes)  ? '0:00': minutes <= 0 ? '0:00' : minutes + ':' + isNaN(seconds) ? '0:00' : seconds;
        $('#countdown').html(end);
