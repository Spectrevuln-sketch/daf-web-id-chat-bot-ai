            ...
            <div class="login-register-page">
                ...
                <div class="form-container">
                    ...
                    <form class="form-flex"  method="post" class="digit-group" data-group-name="digits" data-autosubmit="false" autocomplete="off">
                            <input class="input-text" type="number"  maxlength="1" data-next="num-2" required name="num-1" id="num-1"/>
                            <input class="input-text" type="number" data-previous="num-1" data-next="num-3" maxlength="1" required  name="num-2" id="num-2"/>
                            <input class="input-text" type="number" data-previous="num-2" data-next="num-4" maxlength="1" required  name="num-3" id="num-3"/>
                            <input class="input-text" type="number" data-previous="num-3" data-next="num-5" maxlength="1" required  name="num-4" id="num-4"/>
                            <input class="input-text" type="number" data-previous="num-4" data-next="num-6" maxlength="1" required  name="num-5" id="num-5"/>
                            <input class="input-text" type="number" data-previous="num-5" maxlength="1" required  name="num-6" id="num-6"/>
 ...
 $('.form-flex').each(function() {
    ...
    $input.on('keyup', function(e) {
        ...
        // Right arrow and numbers
            ...
            if ($next_otp_digit.length && $next_otp_digit.hasClass('form-flex')) {
...
// End OTP EVENT
    ...
    //                 $('#checker').append(`<small>${next}</small>`)
    //                 if(next.length === 1){
    //                     e.preventDefault();
