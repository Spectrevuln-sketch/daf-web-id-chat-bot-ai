                ...
                <form method="post" id="register-account-form" action="#" accept-charset="UTF-8" onsubmit="document.getElementById('submit-btn').disabled = true;">
                    ...
                    <div class="form-group">
                        <div class="input-with-icon-left">
                            ...
                            <input type="number" class="input-text with-border" placeholder="<?php _e("Nomor Whatsapp") ?>" value="<?php _esc($nomor_wa)?>" id="no_wa" name="no_wa" onBlur="checkAvailabilityPhone()" required/>
                        </div>
