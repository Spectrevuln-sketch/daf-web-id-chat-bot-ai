        ...
        <form method="post" data-ajax-action="addEditUser" id="sidePanel_form">
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <?php foreach($fetch_chat_bot as $key): ?>
                        <?= var_dump(array_search($chat_bot['id'], $serializeBot)) ?>
                            <option value="<?= $chat_bot['id']; ?>" <?= array_search($chat_bot['id'], $serializeBot) >=0 ? 'selected' : ''  ?>><?= $chat_bot['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
