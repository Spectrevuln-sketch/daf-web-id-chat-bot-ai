            ...
            <div class="form-body">
                ...
                <div class="form-group">
                    ...
                    <?php foreach($fetch_chat_bot as $chat_bot): ?>
                            <option value="<?= $chat_bot['id']; ?>" <?= filterBot($chat_bot['id'], $serializeBot); ?>><?= $chat_bot['name']; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label for="id_phone"><?php _e("Whatsapp Number"); ?></label>
                    <input id="id_phone" type="number" class="form-control" name="phone" value="<?php _esc($fetchuser['phone']);?>">
                </div>
                <div class="form-group">
