...
<div class="header-widget">
                            <span class="user-block"><?php _esc($_SESSION['user']['phone']); ?></span>
                                ...
                                <div class="header-notifications-dropdown">
                                    <ul class="user-menu-small-nav">
                                        ...
                                        foreach ($html_pages as $html_page){ ?>
                                            <li><a href="<?php _esc($config['site_url'] . 'page/' . $html_page['slug']) ?>"><i class="icon-feather-file-text"></i> <?php _esc($html_page['title']) ?>
                                                </a></li>
                                        <?php } ?>
                                        <li><a id="logout" href="<?php url("LOGOUT") ?>"><i
