                                        ...
                                        <div class="col-xl-6 col-md-12">
                                            <div class="submit-field">
                                                ...
                                                <div class="input-with-icon-left">
                                                    ...
                                                    <input type="text" readonly class="with-border" id="phone" name="phone" value="<?php _esc($email_field)?>" onBlur="checkAvailabilityPhone()">
                                                </div>
                                                <span id="wa-availability-status"><?php if($email_error != ""){ _esc($email_error) ; }?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
